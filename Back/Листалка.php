...
<body id="111">
<form action="javascript:void(0);" method="post"><button class="btn btn-success mb-1"  id="sd" data-toggle="modal" data-target="#shGroup">Расписание группы</button>
    <button class="btn btn-success mb-1"  id="dd" data-toggle="modal" data-target="#shTeach"> Расписание преподавателя</button>
    <button class="btn btn-success mb-1"  data-toggle="modal" data-target="#shAud"> Расписание аудитории</button>
    <button class="btn btn-success mb-1"    value="2022-04-11" onclick="showUser(this.value)">2022-04-11</button>
    <button class="btn btn-success mb-1"    value="2022-04-18" onclick="showUser(this.value)">2022-04-18</button>
