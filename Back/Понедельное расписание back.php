...
<body>
<button class="btn btn-success mb-1"  data-toggle="modal" data-target="#shGroup"><i class="fa fa-plus"> Добавить запись</i></button>
            ...
            <div class="modal-body">
                <form action="test1.php" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="add" class="btn btn-primary" >Посмотреть расписание</button>
